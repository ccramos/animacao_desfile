...
#### !!!! Importando e trabalhando os dados da tabela "alunos3rao.CSV" !!!! ####

banco_alunos = pd.read_csv("python/alunos3rao.CSV")

#*criando tabelas separadas pra meninos e meninas

banco_meninas = banco_alunos[ banco_alunos['H x M'] == 'M']
banco_meninas = banco_meninas.sort_values(by = 'Altura', ascending = False)
banco_meninos = banco_alunos[ banco_alunos['H x M'] == 'H']
banco_meninos = banco_meninos.sort_values(by = 'Altura', ascending = True)
banco_meninos.to_csv('static/meninos3rao.csv')
banco_meninas.to_csv('static/meninas3rao.csv')

# def remover_aluno(numero = None, turma = None):
# 	banco_alunos.
...
#*função para atualizar os dados nas tabelas afilhadas
def atualizar_dados():
	banco_meninas = banco_alunos[ banco_alunos['H x M'] == 'M']
	banco_meninas = banco_meninas.sort_values(by = 'Altura', ascending = False)
	banco_meninos = banco_alunos[ banco_alunos['H x M'] == 'H']
